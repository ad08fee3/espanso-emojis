...
**Note**: There are two options for this package. One with spaces between words, and one with underscores. This version uses _spaces._
For example `:kissing face:`

To install the version with underscores use https://hub.espanso.org/actually-all-emojis
